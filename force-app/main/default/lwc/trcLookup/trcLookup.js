...
const SEARCH_DELAY = 1; // Wait 300 ms after user stops typing then, peform search
...
export default class TrcLookup extends NavigationMixin(LightningElement) {
    // Public properties
    ...
    // handleClick(event) {
    //   let response = {};
    //   response.object = this.objectName;
    //
